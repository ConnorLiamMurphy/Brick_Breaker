...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v3.1.0"
  WORKING_DIRECTORY "/Users/sphealie/Desktop/CIS-376/Brick_Breaker/build/_deps/box2d-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sphealie/Desktop/CIS-376/Brick_Breaker/build/_deps/box2d-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sphealie/Desktop/CIS-376/Brick_Breaker/build/_deps/box2d-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
